...
<input id="searchField" type="text" name="shippingName" placeholder="shippingName" />
	<input id="searchField" type="text" name="shippingzip" placeholder="shippingZip" />
	<input id="searchField" type="text" name="billingzip" placeholder="billingZip" />
	<input id="searchField" type="text" name="billingName" placeholder="billingName" />
</div>
<input type="submit" />
</form>
<script>
   ...
   autocomplete(document.getElementById("searchField"), shippingName);
	autocomplete(document.getElementById("searchField"), shippingZip);
	autocomplete(document.getElementById("searchField"), billingName);
	autocomplete(document.getElementById("searchField"), billingZip);
  </script>
</body>
</html>
